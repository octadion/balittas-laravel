                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <h2 class="font-weight-600 mb-4"style="color:#000000;">
                      <center>
                          KEPUASAN PELANGGAN BALITTAS MALANG
                      </center>
                    </h2>

                    <h3>Formulir Kepuasan Pelanggan :</h3>
                    <center><img src="../assets/images/dumas.jpg"
                      alt="banner" class="img-fluid" height="550" width="600"/></center><br>
                    <ul><strong>Berikut Link Untuk Masuk Ke Form Kepuasan Pelanggan Balittas :</strong></ul>
                    <center>
                      <a href="https://docs.google.com/forms/d/e/1FAIpQLSdq6YXiWtunbpr_g9CCG0J844idtv1e_3GZ3e2uumTevg5Gjg/viewform"><button type="button" class="btn btn-success">Masuk Link Form</button></a>
                    </center>
                    </div>
